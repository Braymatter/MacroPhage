...
use crate::{util::camera::{CameraState, PlayerCamMarker}, map::LevelManagerRes};

use super::{UIState, UIStateRes};


pub fn game_hud(mut egui_context: ResMut<EguiContext>, mut ui_state: ResMut<UIStateRes>, mut player_cam: Query<(&mut CameraState, &PlayerCamMarker)>,  mut level_manager: ResMut<LevelManagerRes>){
